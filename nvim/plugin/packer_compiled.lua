...
_G.packer_plugins = {
  ...
  ["crease.vim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/crease.vim",
...
vim.cmd [[au FileType liquid ++once lua require("packer.load")({'vim-prettier'}, { ft = "liquid" }, _G.packer_plugins)]]
