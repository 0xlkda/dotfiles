...
# Tunneling Tailscale
# A function, not an alias: zsh expands aliases *before* completion (complete_aliases
# is off), which would send `tailscale <TAB>` looking for the .app basename and lose
# the _tailscale completion. A function keeps the command name "tailscale".
